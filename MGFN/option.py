...
def parse_args():
    ...
    parser.add_argument('--test-rgb-list', default='/content/drive/MyDrive/aaa for projects/github client project./ucf-i3d-test.list', help='list of test rgb features ')

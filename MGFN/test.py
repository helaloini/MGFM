...
if __name__ == '__main__':
    ...
    model_dict = model.load_state_dict({k.replace('module.', ''): v for k, v in torch.load('/content/drive/MyDrive/aaa for projects/github client project./PreTrainedModels/MGFN results/UCF_pretrained/mgfn_ucf.pkl').items()})
